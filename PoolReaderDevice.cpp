...
PoolReaderDevice::PoolReaderDevice(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6, uint8_t ID7):
        PoolReader(ID1, ID2, ID3, ID4, ID5, ID6, ID7),
...
void PoolReaderDevice::setOrp(int16_t orp){ //between -2000 and 2000mV (res 3.2mV)
